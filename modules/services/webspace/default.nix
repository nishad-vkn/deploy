...
let
  cfg = config.opencloud.services.webspace;
  ...
  basedir = "/var/www";
  group = config.opencloud.services.lighttpd.group;
  ...
  '';
in {
  options.opencloud.services.webspace = {
    enable = mkEnableOption "opencloud webspace";
      ...
      type = types.attrsOf (types.submodule {
        ...
        options.virtualHosts = mkOption {
          ...
          description = ''
            ...
            <option>opencloud.services.lighttpd.virtualHosts</option>.
          '';
        };
      });
      description = ''
        ...
        merged with <option>opencloud.services.lighttpd.virtualHosts</option>.
      '';
    };
  };
