...
let
  ...
  xmppVHosts = filterAttrs (const isXmppVHost) config.opencloud.vhosts;
  ...
  in [
    (mkInfo {
      ...
      value = "mailto:abuse@opencloud.software";
    })
    (mkInfo {
      modules = singleton "mod_disco";
      field = "feedback-addresses";
      value = "xmpp:main@conference.opencloud.software";
    })
    (mkInfo {
  ...
  modules = {
    ...
    pubsub.options = {
      ...
      host = "pubsub.opencloud.software";
    };
    ...
    disco.options = {
      access.atom = "public";
      inherit server_info;
      extra_domains = map (base: { binary = "${base}.opencloud.software"; }) [
    ...
    mam_meta.options = {
      backend.atom = "odbc";
      host = "conference.opencloud.software";
...
in {
  opencloud.services.acme.domains = mapAttrs' (const (vhost: {
    name = head vhost.ssl.domains;
    value.users = [ "mongoose" ];
    value.reloads = [ "mongooseim" ];
  })) xmppVHosts;

  opencloud.postgresql.databases.mongooseim = {
    users.mongooseim = {
      password = hclib.getcred [ "xmpp" "dbpasswd" ] "verysecure";
    };
    schemaFile = "${pkgs.opencloud.mongooseim.mainAppDir}/priv/pg.sql";
  ...
  opencloud.services.mongooseim = {
      ...
      modules = modules // {
        ...
        disco.options = {
          ...
          extra_domains = [
            ...
            { binary = "pubsub.opencloud.software"; }
          ];
        };
    ...
    settings = {
      hosts = [
        ...
        "opencloud.business"
        "opencloud.marketing"
        "greenhopperevent.com"
        #"anonymous.opencloud.software"
      ];
      ...
      s2s.certfile = xmppVHosts.opencloud.ssl.allInOne;
      ...
      acl.patterns = {
        local.user.regex = "";
        anonymous.server = "anonymous.opencloud.software";
        ...
        admin = { user = "admin"; server = "opencloud.software"; };
        wallops = { user = "wallop"; server = "opencloud.software"; };
      ...
      # See issue #13!
      # {host_config, "anonymous.opencloud.software", [
