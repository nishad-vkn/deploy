...
let
    ...
    nixpkgs.overlays = lib.singleton (lib.const (super: {
      cacert = super.cacert.overrideDerivation (drv: {
        installPhase = (drv.installPhase or "") + ''
          cat "${nodes.ca.config.opencloud.snakeOilCaCert}" \
  ...
  in {
    ...
    nodes = nodes // {
      ...
      torservers = { pkgs, lib, ... }: {
        ...
        opencloud.mainIPv4 = "81.7.6.108";
        opencloud.mainIPv6 = "2a02:180:a:25:5::1";
      ...
      resolver = { nodes, pkgs, lib, ... }: {
        ...
        services.bind.zones = lib.singleton {
          ...
          file = pkgs.writeText "torservers.zone" ''
            ...
            @ IN A    ${nodes.torservers.config.opencloud.mainIPv4}
            @ IN AAAA ${nodes.torservers.config.opencloud.mainIPv6}

            jabber IN NS ns1.opencloud.org.
            jabber IN NS ns2.opencloud.org.

            _acme-challenge IN NS ns1.opencloud.org.
  ...
  testedVHosts = [ "opencloud" "aszlig" "noicq" "no_icq" "torservers" ];
